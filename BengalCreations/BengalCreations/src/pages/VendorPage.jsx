...
/* ═══════════════════════════════════════════════════════
   VENDOR PAGE — Full Dashboard Hub
   ═══════════════════════════════════════════════════════ */
    ...
    <div className="dp-layout">
      ...
      <aside className={`dp-sidebar ${sidebarOpen ? "dp-sidebar--open" : ""}`}>
        ...
        <div className="dp-upgrade-box">
          ...
          <p className="dp-upgrade-desc">Upgrade to premium and get more features.</p>
            ...
            <div className="dp-content-grid">
              ...
              <div className="dp-card">
                <div className="dp-card-header">
                  ...
                  <button className="dp-card-link" onClick={() => navTo("myproducts")}>View All Products →</button>
                </div>
                {!dashProducts.length ? (
                  <div className="dp-empty">
                    <div style={{ fontSize: 40 }}>📦</div>
                    <p>No products yet. <button className="dp-card-link" onClick={() => navTo("addproduct")}>Add one now!</button></p>
                  </div>
                ) : (
              ...
              <div className="dp-card">
                <div className="dp-card-header">
                  ...
                  <button className="dp-card-link" onClick={() => navTo("orders")}>View All Orders →</button>
                </div>
                {!orders.length ? (
